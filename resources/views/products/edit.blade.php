...
<div class="container-fluid px-3 px-md-4 py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-2 fw-bold">ویرایش محصول</h1>
        ...
        <div class="col-12 col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 fw-bold">ویرایش اطلاعات محصول</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('products.update', $product) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control @error('category') is-invalid @enderror" id="category" name="category" value="{{ old('category', $product->category) }}" list="categories">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="form-select @error('unit') is-invalid @enderror" id="unit" name="unit" required>
                                    ...
                                    <option value="کارتن" {{ old('unit', $product->unit) == 'کارتن' ? 'selected' : '' }}>کارتن</option>
                                </select>
                                @error('unit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
